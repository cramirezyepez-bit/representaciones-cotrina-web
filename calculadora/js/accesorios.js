...
export const CATALOGO_ACCESORIOS = {
  ...
  escuadras:           { nombre: 'Escuadras',                          unidad: 'unidad',   precioUnitario: 9,   aplicaA: 'item' },
  tornillos:           { nombre: 'Tornillos',                         unidad: 'unidad',   precioUnitario: 0.6, aplicaA: 'item' },
  felpas:              { nombre: 'Felpas',                             unidad: 'metro',    precioUnitario: 8,   aplicaA: 'item' },
  burletes:            { nombre: 'Burletes',                           unidad: 'metro',    precioUnitario: 6,   aplicaA: 'item' },
